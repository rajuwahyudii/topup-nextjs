            ...
            <li className="nav-item my-auto dropdown d-flex">
                            ...
                            <div>
                                ...
                                <ul className="dropdown-menu border-0" aria-labelledby="dropdownMenuLink" >
                                    <li>
                                        <Link href={""}><a className="dropdown-item text-lg color-palette-2" >My Profile</a></Link></li>
                                    <li> <Link href={""}><a className="dropdown-item text-lg color-palette-2" >Wallet</a></Link></li>
                                    <li><Link href={""}><a className="dropdown-item text-lg color-palette-2" >Account Settings</a></Link>
                                    </li>
