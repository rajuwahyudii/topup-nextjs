...
import LinkFooter from '../../molecules/LinkFooter'
                ...
                <div className="row gap-sm-0">
                  <div className="col-md-4 col-6 mb-lg-0 mb-25">
                    ...
                    <ul className="list-unstyled">
                      ...
                      <LinkFooter href='/#' title='Press Release'/>
                      <LinkFooter href='/#' title='Terms of Use'/>
                      <LinkFooter href='/#' title='Privacy Policy'/>
                    </ul>
                  </div>
                  <div className="col-md-4 col-6 mb-lg-0 mb-25">
                    <p className="text-lg fw-semibold color-palette-1 mb-12">Support</p>
                    <ul className="list-unstyled">
                    <LinkFooter href='/#' title='Refund Policy'/>
                    <LinkFooter href='/#' title='Unlock Rewards'/>
                    <LinkFooter href='/#' title='Live Chatting'/>
                    </ul>
                  </div>
                  <div className="col-md-4 col-12 mt-lg-0 mt-md-0 mt-25">
                    <p className="text-lg fw-semibold color-palette-1 mb-12">Connect</p>
                    <ul className="list-unstyled">
                    <LinkFooter href='/#' title='hi@topupstore.com'/>
                    <LinkFooter href='/#' title='team@topupstore.com'/>
                    <LinkFooter href='/#' title='Bengkulu, Indonesia'/>
                    <LinkFooter href='/#' title='0869696969'/>
                    </ul>
                  </div>
                </div>
              </div>
