                    ...
                    <div className="main-content main-content-card overflow-auto">
                        <section className="checkout mx-auto">
                            ...
                            <div className="purchase pt-30">
                                ...
                                <Row label='Your Game ID' value='Nayanika'/>
                                <Row label='Order ID' value='#NYNK'/>
                                <Row label='ItemD' value={500000}/>
                                <Row label='Price' value={500000}/>
                                <Row label='Tax 10%' value={50000}/>
                                <Row label='Total' value={900000} className='color-palette-4'/>
                                
                            </div>
                            <div className="payment pt-10 pb-10">
                                <h2 className="fw-bold text-xl color-palette-1 mb-20">Payment Informations</h2>
                                <Row label='Your Account Name' value='Nayanika'/>
                                <Row label='Type' value='orldwide
                                        Transfer'/>
                                <Row label='Bank Name' value='Mandiri'/>
                                <Row label='Bank Account Name' value='Raju Wahyudi Pratama'/>
                                <Row label='Bank Number' value='123123123'/>
